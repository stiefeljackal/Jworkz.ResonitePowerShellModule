...
/// <summary>
/// Retrieves an asset blob from NeosVR
/// </summary>
[Cmdlet(VerbsCommon.Get, "NeosAssetGather", DefaultParameterSetName = PARAM_SET_SAVEFILE)]
public class GetAssetGather : NeosAssetInfoCmdlet
{
